...
bcplot
ggsave("output/brayc_hiv36hr.png", bcplot, height = 3, width = 4)
...
jaccplot
ggsave("output/jacc_hiv36.png", jaccplot, height = 3, width = 4)
...
uwuplot
ggsave("output/unweighunifrac_hiv36.png", uwuplot, height = 3, width = 4)
...
wuplot
ggsave("output/weighunifrac_hiv36.png", wuplot, height = 3, width = 4)
